...
export const FrontLines = () => {
  return (
    <>
      {/* 눈 주위 라인 */}
      <Line start={[-0.56, 0.05, 1.0]} end={[-1.0, 0.5, 1]} />
      <Line start={[-1.0, 0.5, 1]} end={[-1.5, 0.5, 1]} />
      {/* 관자놀이 라인 */}
      <Line start={[-0.86, -0.35, 0.65]} end={[-1.5, -0.35, 1]} />
      {/* 턱 라인 */}
      <Line start={[-0.0, -1.11, 0.65]} end={[-1.0, -1.2, 1]} />
      <Line start={[-1.0, -1.2, 1]} end={[-1.6, -1.2, 1]} />
      {/* 코 주위 라인 */}
      <Line start={[0.0, -0.5, 1.3]} end={[1.0, -1.2, 1]} />
      <Line start={[1.0, -1.2, 1]} end={[1.5, -1.2, 1]} />
      {/* 눈 라인 */}
      <Line start={[0.5, -0.35, 0.95]} end={[1.0, -0.35, 1]} />
      <Line start={[1.0, -0.35, 1]} end={[1.5, -0.35, 1]} />
      {/* 이마의 띄 라인 */}
...
export const BackLines = () => {
  return (
    <>
      {/* 뒷머리 주위 라인 */}
      <Line start={[-0.56, 0.05, 0.8]} end={[-1.0, 0.5, 1]} />
      <Line start={[-1.0, 0.5, 1]} end={[-1.5, 0.5, 1]} />
      {/* 뒷목 라인 */}
